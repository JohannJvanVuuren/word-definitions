...
/* Import of module needed in this component */
...
export const SearchResult = ({searchWord, error, data}) => {
    ...
    * return portion of this component for simplicity’s sake considering the complexity of the data. */
    ...
    /* Declaration and initialisation of useNavigate hook */
    ...
    return (
        <div className={"result-box"}>
            ...
            {/* The diversion to the error page when HTTP no connection errors occur */}
            {error && console.log(error)}
            {error && navigate("/errors")}
